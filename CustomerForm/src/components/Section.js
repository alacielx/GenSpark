...
const Section = () =>{
    return(
        <div id="main_sec">
            ...
            <input type="checkbox" id="check" value="Approve"/><label for="check">I agree all the information above is correct and that it can be used for anything we please.</label><br/>
